...
*> **Note**: Time range downloads and 4K download are slower than full downloads.

---

## 📋 Requirements

This extension needs the following tools installed on your computer (everything is installed automatically):
